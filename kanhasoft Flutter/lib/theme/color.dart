...
class MyColors {
  ...
  static var color_6E7578 = const Color(0xFF6E7578);

  static var color_E2E9EF = const Color(0xFFE2E9EF);
  static var color_F1871933 = const Color(0xF1871933);
  static var color_0A0F3712 = const Color(0x0A0F3712);

  static var color_2FA2DB = const Color(0xFF2FA2DB);
  ...
  static var color_2FA1DB33 = const Color(0x2FA1DB33);

  static var color_E4E8EB = const Color(0xFFE4E8EB);
}
